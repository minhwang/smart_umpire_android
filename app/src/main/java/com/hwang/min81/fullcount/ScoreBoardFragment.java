...
public class ScoreBoardFragment extends Fragment implements Score.ScoreChangedListener {
    ...
    private static final String ARG_AWAY_SCORE = "param2";
    ...
    private TeamScoreView mHomeTeamScoreView;
    private TeamScoreView mAwayTeamScoreView;
    private InningView mInningView;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            mParam1 = getArguments().getString(ARG_HOME_SCORE);
            mParam2 = getArguments().getString(ARG_AWAY_SCORE);
        }
    }
