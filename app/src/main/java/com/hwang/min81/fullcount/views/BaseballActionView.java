...
import com.hwang.min81.fullcount.BaseballActionPager;
...
public class BaseballActionView extends PopupWindow implements ViewPager.OnPageChangeListener, View.OnClickListener {
    ...
    class BaseballActionPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            else if(position == BaseballActionPager.MANAGING.getPagePosition()) {
                contentView.findViewById(R.id.btnPerformSummary).setOnClickListener(performActionListener);
            }
