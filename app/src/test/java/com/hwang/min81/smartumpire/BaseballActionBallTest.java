...
public class BaseballActionBallTest {
    ...
    public BaseballActionBallTest(int ball, int strike, int out, int expectedBall, int expectedStrike, int expectedOut) {
    ...
    public void PerformingBallActionAddOneMoreBall() throws BallStrikeOutCounter.OutOfRangeException {
        ...
        BaseballActionBall baseballActionBall = new BaseballActionBall(ballStrikeOutCounter);
