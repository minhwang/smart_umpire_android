...
public class BaseballActionStrikeTest {
    ...
    public BaseballActionStrikeTest(int ball, int strike, int out, int expectedBall, int expectedStrike, int expectedOut) {
    ...
    @Test
    public void PerformingBallActionAddOneMoreBall() throws BallStrikeOutCounter.OutOfRangeException {
        ...
        BaseballActionStrike baseballActionStrike = new BaseballActionStrike(ballStrikeOutCounter);
