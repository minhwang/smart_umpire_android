...
@SmallTest
public class BaseballActionBatterOutTest {
    ...
    public BaseballActionBatterOutTest(int ball, int strike, int out, int expectedBall, int expectedStrike, int expectedOut) {
    ...
    @Test
    public void PerformingBatterOutActionResetBallStrikeCountAndAddOneOutCount() throws BallStrikeOutCounter.OutOfRangeException {
        ...
        BaseballActionBatterOut baseballActionBatterOut = new BaseballActionBatterOut(ballStrikeOutCounter);
        baseballActionBatterOut.perform();
